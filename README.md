...
| [Concepts](./setup/README.md)                                      |      15 min | Describe how JVM executes Java programs and ensures portability.|
| [JVM Memory Areas](./jvm-memory-areas/README.md)                   |      20 min | Describe the workings of stack and heap.                        |
| [The Garbage Collector](./the-garbage-collector/README.md)         |      15 min | Describe the garbage collector and its function.                |
| [Performance Tuning Basics](./performance-tuning-basics/README.md) |      30 min | Investigate `OutofMemory` and `StackOverflow` exceptions.       |
